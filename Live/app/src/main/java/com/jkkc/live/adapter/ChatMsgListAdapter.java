package com.jkkc.live.adapter;

import android.content.Context;
import android.widget.TextView;

import com.jkkc.live.R;
import com.jkkc.live.base.BaseAdapter;
import com.jkkc.live.model.ChatMsg;
...
public class ChatMsgListAdapter extends BaseAdapter<ChatMsg> {
	...
	protected void initData(ViewHolder viewHolder, ChatMsg data, int position) {
		...
		//谁发给谁的消息是
		tvMsg.setText(String.format("%s发给%的消息是%s",
				data.sendName,data.receiveName,data.msg));
